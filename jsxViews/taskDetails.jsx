    ...
    var TaskResourceList = React.createClass({
        render: function () {
            ...
            var resourceNodes = resources.map(function (resource) {
                counter++;
                return (
                    <Resource data={resource} taskId={taskId} key={counter} counter={counter} isSurvey={false}/>
                );
            });
            if (this.props.surveys && this.props.surveys.length > 0) {
                ...
                var surveyNode = surveys.map(function(survey){
                    ...
                    return (
                        <Resource data={questionData} taskId={taskId} key={counter} counter={counter} isSurvey={true}/>
                    );
                });
