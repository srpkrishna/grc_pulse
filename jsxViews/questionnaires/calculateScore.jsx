...
define (function (require){
    ...
    function calculate (questionnaire) {
        var weightage = questionnaire.grcpulse_Weightage__c;
                ...
                case questionType.SINGLE_ANSWER:
                {
                    ...
                    for (var i = 0; i < options.length; i++) {
                        if (userAnswer === options[i].Id) {
                            score = options[i].grcpulse_Score__c * weightage;
                            break;
                        }
                    }
                    break;
    ...
    var CalculateScore = React.createClass ({
        ...
        render: function () {
           var isHiddenCss = "attestationContainer" + (this.state.isVisible ? "" : " visibilityNone");
            ...
            return (
                <div className={isHiddenCss} onClick={this._onClick}>
                    <div className={btCSS}>{getString("next")}</div>
                </div>
            );
        }
    });
