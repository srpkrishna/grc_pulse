define(function (require) {
    ...
    var packs = React.createClass({displayName: "packs",
        ...
        _goToCardDetail: function () {
            ...
            qParams = qParams + "&" + "pdesc=" + (pack.grcpulse_Pack_Description__c ? pack.grcpulse_Pack_Description__c : "");
        ...
        getPacksUI: function () {
            ...
            if (currentVal < packs.length - 1) {
                obj.push(React.createElement("div", {key: "bgunread", className: "packCardBG"}));
            ...
            for (var i = currentVal - 1; i < currentVal + 1; i++) {
                ...
                obj.push(
                    React.createElement("div", {className: cssName, key: i, id: "packCard"+i}, 
                        ...
                        React.createElement("div", {className: "packSubName"}, pack.grcpulse_Pack_Description__c ? pack.grcpulse_Pack_Description__c : ""), 
            ...
            if (currentVal > 1) {
                obj.push(React.createElement("div", {key: "bgread", className: "packCardBG read"}));
            }
            return obj;
        ...
        render: function () {
            ...
            return (
                React.createElement("div", null, 
                    React.createElement("div", {className: "pageTitle"}, getString("grc_packs")), 
                    contents
                )
            );
        }
